...
<template>
  <section
    class="bg-[url('https://carconfigurator.ferrari.com/assets/cars/portofinom/packages/default/car-ferrari-portofino-m_splash.jpg')]"
  >
    <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" action="#" @submit.prevent="">
            ...
            <div class="flex items-center justify-between">
              ...
              <a
                href="#"
                class="text-sm font-medium text-gray-300 text-primary-600 hover:underline dark:text-primary-500"
                >Forgot password?</a
              >
            </div>
            <button
